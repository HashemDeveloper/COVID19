...
class ConnectionStateMonitor @Inject constructor(private val context: Context) : LiveData<Boolean>(),
    ...
    @Inject
    lateinit var covid19BroadcastReceiver: Covid19BroadCastReceiver
            ...
            withContext(Dispatchers.IO) {
                when {
                    ...
                    Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP -> {
                        ...
                        context.registerReceiver(covid19BroadcastReceiver, IntentFilter(Constants.CONNECTIVITY_ACTION))
                    }
                }
            }
        }
        ...
        launch {
            withContext(Dispatchers.IO) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    context.unregisterReceiver(covid19BroadcastReceiver)
                }
            }
        }
    }
